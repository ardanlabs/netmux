...
func (s *Service) ReverseProxyListen(listenServer cluster.Cluster_ReverseProxyListenServer) error {
	for {
...
func (s *Service) listener(listenServer cluster.Cluster_ReverseProxyListenServer, brd bridge.Bridge) error {
